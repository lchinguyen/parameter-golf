# Recurrent + Bigram Transformer Experiment (by Chi L. Nguyen) @ OpenAI Parameter Golf Challenge:
...
Despite running locally on Apple Silicon with partial validation (`VAL_MAX_BATCHES=100`) rather than full 8xH100, my method achieved:
